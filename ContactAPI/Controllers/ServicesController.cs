...
namespace Contact.API.Controllers
{
    ...
    public class ServicesController : ControllerBase
    {
        ...
        // GET by category — всі ролі
        [HttpGet("category/{category}")]
        public async Task<IActionResult> GetByCategory(string category) =>
            Ok(await _context.Services.Where(s => s.Category.ToLower() == category.ToLower()).ToListAsync());
        ...
        // PUT — superadmin та admin
        [HttpPut("{id}")]
        [Authorize(Roles = "superadmin,admin")]
        public async Task<IActionResult> Update(int id, Service u)
        {
        ...
        // DELETE — тільки superadmin та admin (master НЕ може)
        [HttpDelete("{id}")]
        [Authorize(Roles = "superadmin,admin")]
